...
# Exercise-2 TODOs:
    ...
    # Since robot is looking from top to bottom, it is not really captures staff under the table.
    # So removing only small part under the table should be sufficient.
    axis_min = 0.60
    axis_max = 2
