...
def compute_normal_histograms(normal_cloud):
    ...
    x_hist = np.histogram(norm_x_vals, bins=32, range=(-100, 100))
    y_hist = np.histogram(norm_y_vals, bins=32, range=(-100, 100))
    z_hist = np.histogram(norm_z_vals, bins=32, range=(-100, 100))
